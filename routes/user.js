...
route.post('/singnin/',userAuth.authentification,userControll.singnin,userControll.sendOtpCode)
route.post('/login/',userAuth.authentification,userControll.login)
